...
__all__ = ('DFL', 'HGBlock', 'HGStem', 'SPP', 'SPPF', 'C1', 'C2', 'C3', 'C2f', 'C3x', 'C3TR', 'C3Ghost',
           'GhostBottleneck', 'Bottleneck', 'BottleneckCSP', 'Proto', 'RepC3','C2f_MOTABlock_EMA')
...
class MOATBlock(nn.Module):
    def __init__(self,
        ...
        # Init Attention
        self.EMA_attention = EMA(channels=in_channels)
    ...
    def forward(self, input: torch.Tensor) -> torch.Tensor:
        ...
        output = self.EMA_attention(output)
        return output


class C2f_MOTABlock_EMA(C2f):
    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self.m = nn.ModuleList(MOATBlock(self.c, self.c) for _ in range(n))